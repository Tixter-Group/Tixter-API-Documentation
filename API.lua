...
-- @param part: The BasePart to tween
-- @param goalPosition: The target position of the part
-- @param duration: Duration of the tween in seconds
-- @param easingStyle: The easing style for the tween
-- @param easingDirection: The easing direction for the tween
...
-- @param model: The Model containing the parts to tween
-- @param displacement: Vector3 indicating how far each part should move
-- @param duration: Duration of the tween in seconds
-- @param easingStyle: The easing style for the tween
-- @param easingDirection: The easing direction for the tween
-- @return tweens: A table containing all created Tween instances
...
-- @param doorsModel: The model containing all PassengerDoor models
-- @param openDuration: Duration of the opening tween in seconds
